...
const isOwner = [`${setting.ownerNumber}`,"628999217649@s.whatsapp.net","628999217649@s.whatsapp.net"].includes(sender) ? true : false
...
reply(`\`\`\`「 Detect Link 」\`\`\`\n\nEh gajadi deh yang kamu kirim rupanya link group ini`)
} else if (isUrl(chats)) {
let bvl = `\`\`\`「 Detect Link 」\`\`\`\n\nEh kamu admin ya kamu dapat mengirim link apapun`
...
conn.sendMessage(sender,{video:{url:tt_res.result.video.link1}, caption:'Nih bre'}, {quotes:msg})
...
var bg_lexxy = '628999217649@s.whatsapp.net'
...
var dev = '628999217649@s.whatsapp.net'
